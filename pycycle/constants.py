...
class DeprecatedDict(dict):
    ...
    def __getitem__(self, key):
        if not self._has_warned:
            ...
            warnings.warn(
                f"Deprecation warning: `{self.old_name}` will be replaced by `{self.new_name}` in pyCycle 4.0",
                DeprecationWarning,
            )
...
# these elemental ratios matter! # Is this like partial pressures? What units are these? Pretty confusing here.
...
TAB_AIR_FUEL_COMPOSITION = {
    "FAR": 0.0
}  # This means fuel is 0 and Air can be anything over 0. Actually also equal to as well.
...
AIR_FUEL_ELEMENTS = DeprecatedDict(
    "AIR_FUEL_ELEMENTS", "CEA_AIR_FUEL_COMPOSITION", CEA_AIR_FUEL_COMPOSITION
)
AIR_ELEMENTS = DeprecatedDict(
    "AIR_ELEMENTS", "CEA_AIR_COMPOSITION", CEA_AIR_COMPOSITION
)
WET_AIR_ELEMENTS = DeprecatedDict(
    "WET_AIR_ELEMENTS", "CEA_WET_AIR_COMPOSITION", CEA_WET_AIR_COMPOSITION
)
CO2_CO_O2_ELEMENTS = DeprecatedDict(
    "CO2_CO_O2_ELEMENTS", "CEA_CO2_CO_O2_COMPOSITION", CEA_CO2_CO_O2_COMPOSITION
)


AIR_FUEL_MIX = DeprecatedDict(
    "AIR_FUEL_MIX", "CEA_AIR_FUEL_COMPOSITION", CEA_AIR_FUEL_COMPOSITION
)
AIR_MIX = DeprecatedDict("AIR_MIX", "CEA_AIR_COMPOSITION", CEA_AIR_COMPOSITION)
WET_AIR_MIX = DeprecatedDict(
    "WET_AIR_MIX", "CEA_WET_AIR_COMPOSITION", CEA_WET_AIR_COMPOSITION
)
CO2_CO_O2_MIX = DeprecatedDict(
    "CO2_CO_O2_MIX", "CEA_CO2_CO_O2_COMPOSITION", CEA_CO2_CO_O2_COMPOSITION
)
